...
interface IUserBookingInteractor{
   ...
   seenNotificationUseCase(notificationId:string):Promise<{success:boolean; message?:string}>
   clearNotificationUseCase(receiverId:string):Promise<{success:boolean, message?:string}>
}
